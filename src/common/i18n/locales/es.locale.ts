export const es = {
    errors: {
        ...
        ROLE_NAME_IN_USE: "Ya existe un rol con ese nombre",
        ROLE_IN_USE: "El rol tiene usuarios asignados y no puede eliminarse",
        ROLE_PROTECTED: "Los roles base del sistema no pueden modificarse ni eliminarse",
        DEFAULT_ROLE_MISSING: "El rol por defecto no existe — ejecutar los seeds de roles",

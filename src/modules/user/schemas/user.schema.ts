...
export const CreateUserSchema = {
  body: z.object({
    ...
    email: z.string().email().openapi({ example: "jp@email.com", description: "Correo electrónico del usuario" }),
    password: z.string().min(8).openapi({ example: "********", description: "Contraseña del usuario" }),
  }).openapi("User")
};
